...
# algo = 2 #RowCOl-dist
# algo = 3 #Misplaced
algoDict = {1 : 'Manhattan', 2:'RowColDif', 3 : 'MisplacedTiles'}
algoList = [1,2,3]
...
def stringtopuzzle(pstr):
    lst = []
    for i in range(len(pstr)):
        lst.insert(0,int(pstr[i]))
...
print("Please enter the init state eg: 012345678")
puzzlelist = input().strip()
puzzle = stringtopuzzle(puzzlelist)
...
for algo in algoList:
    ...
    algoName = str(algoDict[algo])
    print(algoName + " time: "+str(alltime))
    print(algoName + " nodes expanded: "+str(i))
